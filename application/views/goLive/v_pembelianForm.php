...
<body>
    <div style="display: flex; justify-content: center; align-items: center; height: 100vh; background-color:#52BBFF;">
        ...
        <a href="<?php echo base_url('Fildzah-Attira/dataPembelian');?>"" class="d-flex align-items-center link-body-emphasis text-decoration-none">
        ...
        <?php echo $this->session->flashdata('msg'); ?>
            ...
            <form method="post" action="<?php echo base_url('Fildzah-Attira/insertPembelian') ?>">
