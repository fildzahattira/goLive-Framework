...
<body>
    ...
    <div class="container-fluid">
        <a href="<?php echo base_url('Fildzah-Attira/home');?>"" class="d-flex align-items-center link-body-emphasis text-decoration-none">
        ...
        <a class = "btn btn-outline-dark" href = "<?php echo base_url('Fildzah-Attira/insertPembelian');?>" role = "button">ADD NEW DATA</a>
    </div>
    </nav>
        ...
        <tbody>
            <?php foreach ($detail_pembelian as $data) : ?>
                <tr align="center">
                    ...
                    <td>
                        <a class = "btn btn-warning" href = "<?php echo base_url('Fildzah-Attira/updatePembelian/'.$data->k_pembelian);?>" role = "button">UPDATE</a>
                        <a class = "btn btn-danger" href = "<?php echo base_url('Fildzah-Attira/deletePembelian/'.$data->k_pembelian);?>" role = "button">DELETE</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
