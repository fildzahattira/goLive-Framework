...
<body>
    ...
    <div class="container-fluid">
        ...
        <a class = "btn btn-outline-dark" href = "<?php echo base_url('Fildzah-Attira/insertHosting');?>" role = "button">ADD NEW DATA</a>
    </div>
    </nav>
        ...
        <tbody>
            <?php foreach ($detail_hosting as $data) : ?>
                <tr align="center">
                    ...
                    <td>
                        <a class = "btn btn-warning" href = "<?php echo base_url('Fildzah-Attira/updateHosting/'.$data->id_hosting);?>" role = "button">UPDATE</a>
                        <a class = "btn btn-danger" href = "<?php echo base_url('Fildzah-Attira/deleteHosting/'.$data->id_hosting);?>" role = "button">DELETE</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
