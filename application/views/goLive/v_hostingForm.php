...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh; background-color:#52BBFF;">
    <div class="w-25 p-3"  style="background-color:#CCD4E0;">
        <a href="<?php echo base_url('Fildzah-Attira/dataHosting');?>"" class="d-flex align-items-center link-body-emphasis text-decoration-none">
        ...
        <form method="post" action="<?php echo base_url('Fildzah-Attira/insertHosting') ?>">
